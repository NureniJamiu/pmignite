        ...
        <div className={cn("sticky top-0", className)}>
            <HeroHighlight >
                <motion.h1
                    ...
                    className="max-w-6xl mx-auto text-lg leading-8 md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300"
                >
            ...
            <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
                <button className="font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-28 mt-8 z-30 md:text-base text-black text-xs w-fit mx-auto ">
                    PMIgnite
                </button>
            </div>
            <svg
