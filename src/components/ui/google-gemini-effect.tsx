...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("md:sticky top-0", className)}>
            <h1
                className="max-w-6xl mx-auto text-4xl px-5 md:leading-8 md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300"
            >
            ...
            <svg
                ...
                className="hidden md:absolute md:-top-40 w-full"
            >
                <motion.path
